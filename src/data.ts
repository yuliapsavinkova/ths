...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: 't1',
    quote: "Having someone there full-time was completely different from any sitter we'd had before. She was truly there for our pets. Worth every penny.",
    author: "James",
  ...
  {
    id: 't2',
    quote: "We were nervous about leaving our dogs for three weeks, but everything was perfect. Frequent photos, zero stress. We returned to happy pets and a clean home.",
    author: "Mia & Tom",
  ...
  {
    id: 't3',
    quote: "Yulia was a game changer. She managed Barnaby's medication routine perfectly, sent frequent photos, and we returned to a clean house and a relaxed pug.",
    author: "Elena & David",
  ...
  {
    id: 't4',
    quote: "Our dog needs medication twice a day and is shy with strangers. Yulia was the best sitter we have ever had.",
    author: "Sarah",
  ...
  {
    id: 't5',
    quote: "Yulia is a star. She watched our high-energy Border Collie. Her frequent updates and photos gave us complete peace of mind while we were abroad.",
    author: "Marcus",
  ...
  {
    id: 't6',
    quote: "We've had several sitters, but Yulia is by far the most professional. She cared for our Siamese cats and left the house in pristine condition.",
    author: "Catherine",
...
export const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    linkUrl: "https://www.trustedhousesitters.com/house-and-pet-sitters/united-states/california/san-francisco/l/6526245/"
  },
  {
    id: 'faq6',
    question: "What happens in an emergency?",
    answer: "I contact you immediately and follow your provided veterinary or emergency instructions."
  }
];
...
export const SCHEDULE: MonthAvailability[] = [
  ...
  { id: 'm3', monthName: "September", year: 2026, status: "available", note: "Available for Direct Booking" },
  { id: 'm4', monthName: "October", year: 2026, status: "limited", note: "Partial Booking (NorCal)" },
  { id: 'm5', monthName: "November", year: 2026, status: "available", note: "Available for Direct Booking" },
  { id: 'm6', monthName: "December", year: 2026, status: "available", note: "Holiday Booking Window" },
  { id: 'm7', monthName: "January", year: 2027, status: "available", note: "Available for Direct Booking" },
  { id: 'm8', monthName: "February", year: 2027, status: "available", note: "Available for Winter Stays" },
  { id: 'm9', monthName: "March", year: 2027, status: "available", note: "Available for Spring Bookings" },
  { id: 'm10', monthName: "April", year: 2027, status: "available", note: "Available for Spring Bookings" },
  { id: 'm11', monthName: "May", year: 2027, status: "booked", note: "Laguna Beach Booking" },
  { id: 'm12', monthName: "June", year: 2027, status: "available", note: "Available for Summer Bookings" }
];
...
export const SITTER_BIO = {
  ...
  basePrice: 999,
  currency: "USD",
  profileLink: "https://www.trustedhousesitters.com/house-and-pet-sitters/united-states/california/san-francisco/l/6526245/",
...
export const SHOWCASE_ITEMS: ShowcaseItem[] = [
  ...
  },
  {
    ...
    category: 'dogs',
    description: 'Felix is a 6-year-old Golden Retriever who is the sweetest, gentlest giant you could ever meet. He is purely kind-hearted and thrives on early morning and evening beach strolls around Santa Barbara. He absolutely adores swimming and has fantastic off-leash recall—though you do have to keep a watchful eye on him, or he might just slyly steal an unsuspecting picnicker’s lunch!',
  ...
  },
  {
    ...
    category: 'cats',
    description: 'Toast is a majestic 10-year-old Maine Coon with pure YouTube-star energy! He loves heading outside in the crisp morning air and spending most of his time relaxing in the yard. He loves to lie on his back, and if he really trusts you, he’ll even let you pet his fluffy belly!',
  ...
  },
  {
    ...
    category: 'dogs',
    description: 'Squid is a lovable 7-year-old Chihuahua who brings so much warmth and fun! At night, she loves curling up right next to your pillow, and during evening TV time, she’s the ultimate cozy cuddle bug. But once she steps outside, her energetic side takes over as she zooms around the backyard chasing her brothers!',
  ...
  },
  {
    ...
    category: 'dogs',
    description: 'Dallas (9-year-old Chihuahua) and Harper (8-year-old Australian Shepherd) were an absolute joy to care for! Dallas is a total snuggle bug—our blanket cuddles were the highlight of my days! Harper is sweet, playful, and loves being near you, making her company so comforting and fun. Both pups were easy to manage, and once you get used to staying aware around other dogs, everything flows smoothly.',
  ...
  },
  {
    ...
    category: 'dogs',
    description: 'Randall is truly one of a kind. Calm, very smart, well-mannered, and well-behaved—he never pulls on walks, waits patiently in the mornings, and follows all commands. Beyond his perfect behavior, he’s endlessly sweet, gentle, and affectionate, loving belly rubs and sofa snuggles that melt your heart.',
  ...
  },
  {
    ...
    category: 'cats',
    description: 'Pepper is a remarkably self-sufficient cat who spends most of her days roaming outdoors in Austin. A feisty free spirit, she boldly picks fights with every other neighborhood cat—and even raccoons! Yet beneath her tough exterior, she is sweet in nature and loves cozying up when she returns home.',
    petName: 'Pepper (Cat)',
    location: 'Austin, TX',
    year: 2025,
    initialLikes: 44
  },
  {
    id: 's11',
    imageUrl: 'images/rufus.webp',
    videoUrl: 'videos/6d1d0e7941ab4ce6837bb2e9d6ae31df.mov',
    videoThumbnailTime: 38.0,
    title: 'Top of the World Walks with Rufus',
    category: 'videos',
    description: 'Top of the World walks with unbelievable scenery! Rufus, a playful Australian Goldendoodle, loves soaking in the breathtaking views and fresh coastal breezes along every trail.',
    petName: 'Rufus (Australian Goldendoodle)',
    location: 'Laguna Beach, CA',
    year: 2025,
    initialLikes: 74
